...
//      char[] key = {'C', 'B', 'S'};
      ...
      //Emil - Getting encrypted key elsewhere to make it more secure
      String encryptKey = Config.getENCRYPTIONKEY();
      char[] key = encryptKey.toCharArray();

      // Stringbuilder enables you to play around with strings and make useful stuff
      StringBuilder thisIsEncrypted = new StringBuilder();

      // TODO: This is where the magic of XOR is happening. Are you able to explain what is going on? - Explained in report
